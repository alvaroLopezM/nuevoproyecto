...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert('usuario', [
            { id: crypto.randomUUID(), email: 'alopez@uv.mx', passwordhash: await bcrypt.hash('patito', 10), nombre: 'Alvaro Lopez', rolid: AdministradorUUID, protegido: true, createdAt: new Date(), updatedAt: new Date() },
